...
//	public final String GRIDURL="http://10.0.2.15:4444/wd/hub";
	...
	public static String URLFactory(String environment) {
		...
		urls.put("QA", "http://172.17.0.3:8080/digi/"); //goes to docker container
		urls.put("AWS", "http://ec2-18-195-78-49.eu-central-1.compute.amazonaws.com:9998/digi");
		urls.put("PRODUCTION", "http://172.17.0.4:8080/digi");
